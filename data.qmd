...
- We decided to remove **extreme missingness** columns from `df_clean_final`, which will add noise and complexity without contributing to the main objective of the project and columns with **moderate missingness** but high potential value were kept for further analysis.
