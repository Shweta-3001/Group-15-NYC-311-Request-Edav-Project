...
``` 
## How many complaints are received over time? Which months are the busiest?
```{r}
...
## What is the backlog of complaints over time? Is it growing or shrinking?
...
Only non-closed complaints are shown, since closed cases have exited the system.
...
## Where problems occur, and what type of complaints are occurring there?
...
```{r label: heatmap-location-complaint-better, fig-width: 12, fig-height: 8}
...
```{r label: action-taxonomy-location,fig.height= 8, fig.width= 12}
